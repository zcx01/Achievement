...
void light5::initialize()
{
    ...
    texture->CreateTexture(":/config/Lighting/5/container2.png");
    texture->CreateTexture(":/config/Lighting/5/container2_specular.png");
    lightingShader->Use();
...
void light5::render()
{
    ...
    lightingShader->setVec3("light.direction",QVector3D( -0.2f, -1.0f, -0.3f));
...
void light5::initShader()
{
    lightingShader = new Shader;
    lightingShader->AddVertexShader(":/config/Lighting/5/vertex.glsl");
    lightingShader->AddFragmentShader(":/config/Lighting/5/fragment.glsl");
    lightingShader->Link();

    lampgShader = new Shader;
    lampgShader->AddVertexShader(":/config/Lighting/5/lightvertex.glsl");
    lampgShader->AddFragmentShader(":/config/Lighting/5/lightfragment .glsl");
    lampgShader->Link();
}

void light5::renderOver()
{
