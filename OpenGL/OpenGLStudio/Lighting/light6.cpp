...
void light6::initialize()
{
    ...
    texture->CreateTexture(":/config/Lighting/6/container2.png");
    texture->CreateTexture(":/config/Lighting/6/container2_specular.png");
    lightingShader->Use();
...
void light6::initShader()
{
    lightingShader = new Shader;
    lightingShader->AddVertexShader(":/config/Lighting/6/vertex.glsl");
    lightingShader->AddFragmentShader(":/config/Lighting/6/fragment.glsl");
    lightingShader->Link();

    lampgShader = new Shader;
    lampgShader->AddVertexShader(":/config/Lighting/6/lightvertex.glsl");
    lampgShader->AddFragmentShader(":/config/Lighting/6/lightfragment .glsl");
    lampgShader->Link();
}

void light6::renderOver()
{
