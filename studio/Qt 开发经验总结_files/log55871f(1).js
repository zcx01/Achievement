...
"use strict";
function i(e,i){
var t=window.withoutIframe?document.getElementsByClassName("video_iframe rich_pages"):document.getElementsByTagName("iframe");
...
o||(o=i[r+"_handler"]||i),t.removeEventListener?void t.removeEventListener(r,o,!!a):t.detachEvent?void t.detachEvent("on"+r,o,!!a):void("tap"==r&&e()?(i.tap_handler&&(i.tap_handler.touchend_handler=null),
...
if(s){
s=s.split("."),n=n.split("."),/\d+/g.test(s[s.length-1])||s.pop();
for(var a,c,u=P["cp"+e],d=0,p=Math.max(s.length,n.length);p>d;++d){
a=s[d]||0,c=n[d]||0,a=parseInt(a)||0,c=parseInt(c)||0;
var f=P.cp0(a,c);
if(!f)return u(a,c);
}
return r||0==e?!0:!1;
...
function u(){
return p?"ios":g?"android":w?"mac_os":l?"windows":"unknown";
}
var d=navigator.userAgent,p=/(iPhone|iPad|iPod|iOS)/i.test(d),f=/Windows\sPhone/i.test(d),g=/(Android)/i.test(d),m=/MicroMessenger\/([\d\.]+)/i.test(d),w=/mac\sos/i.test(d),l=/windows\snt/i.test(d)&&!f,h=/MPAPP\/([\d\.]+)/i.test(d),v=g&&/miniprogram/.test(d.toLowerCase())||"miniprogram"==window.__wxjs_environment,M=m&&/wxwork/i.test(d),P={
"cp-1":function(n,t){
return t>n;
},
cp0:function(n,t){
