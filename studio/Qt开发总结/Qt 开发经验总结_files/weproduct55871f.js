...
"use strict";
function o(){
return!q.isWechat||N.os.pc||q.is_wxwork?!1:q.isIOS&&q.ltVersion("7.0.15",!1)?!1:q.isAndroid&&window.clientversion<="27001337"?!1:q.isAndroid&&window.clientversion>"2700135F"&&window.clientversion<"27001400"?!1:!0;
}
function a(){
return!q.isWechat||N.os.pc||q.is_wxwork?!1:q.isAndroid&&window.clientversion<"2700143c"?!1:q.isIOS&&window.clientversion<"17001228"?!1:!0;
}
function r(){
return N.os.pc?q.isMac&&q.cpVersion("3.1.0",1,!0,"mac")?!0:q.isWindows&&q.getWindows()>="63030000"?!0:!1:!1;
}
function s(e,t,n){
M.report(21146,{
BizUin:Q,
...
function d(e){
return"live"===e?((q.isAndroid&&window.clientversion<"2700143c"||q.isIOS&&window.clientversion<"17001228")&&window.weui.alert("请升级微信客户端版本后查看"),
void(q.isWechat&&N.os.pc?window.weui.alert("当前版本暂不支持查看，请在手机上查看"):(!q.isWechat||q.is_wxwork)&&i("请在微信内打开"))):q.isAndroid&&window.clientversion>"2700135F"&&window.clientversion<"27001400"?void window.weui.alert("当前版本暂不支持查看"):(q.isWechat&&N.os.pc?window.weui.alert("当前版本暂不支持查看，请在手机上查看"):(!q.isWechat||q.is_wxwork)&&i("请在微信内打开"),
void(!q.isWechat||N.os.pc||q.is_wxwork||F.jumpUrl("https://support.weixin.qq.com/update/",!0)));
}
function c(e){
if(a()){
var t={
...
z.invoke("openUrlWithExtraWebview",{
url:i,
openType:1
},function(e){
...
var t=e.parentNode;
if(t){
var n=t.getAttribute("data-id"),i=p(n),o=void 0;
i&&i.length>0&&(o=i[0]);
...
R.report(5,i,n,g(i)),K=g(i),c(n);
},n=0;n<e.length;n++){
var i=e[n];
T.on(i,"tap",t),W.addAppmsgCardTouchEvent(i,".js_channel_btn_operation");
}
}
function h(e,t,n){
return q.is_wxwork||!q.isWechat?void window.weui.alert("请在微信内操作"):q.isInMiniProgram?void window.weui.alert("请在手机微信内操作"):void U({
...
1===n?V.addClass(a,"weui-btn_disabled"):V.removeClass(a,"weui-btn_disabled");
}
var r=w(t);
...
return H instanceof Array&&H.forEach(function(e){
e.notice_id===n&&(o=e.export_id);
}),R.report(4,n,i,g(n)),K=g(n),u(i,o),!1;
},n=function(n){
var i=e[n],o=parseInt(i.getAttribute("data-status"),10);
2===o?T.on(i,"tap",t):0===o&&T.on(i,"tap",function(){
...
return"0"===t?R.report(2,e,n,g(e)):R.report(3,e,n,g(e)),h(n,e,"0"===t?1:2,i),!1;
});
},i=0;i<e.length;i++)n(i);
}
function y(){
if(L&&L.length&&J.length===L.length)return void T.off(window,"scroll",y);
for(var e=0;e<L.length;e++){
var t=L[e],n=t.firstChild;
...
-1===J.indexOf(i)&&(J.push(i),"live"===a?R.report(1,i,o,g(i)):s(1,i,o));
}
}
}
function j(e,t,n,i){
for(var o=document.querySelectorAll('.js_wechannel_live_card[data-noticeid="'+e+'"]'),a=0;a<o.length;a++){
var r=o[a],s=r.querySelector('.js_channel_btn_operation[data-noticeid="'+e+'"]'),d=D.getStatusWording(t,n),c=D.getStatusDesc(i,t);
...
0!==t&&2!==t||0!==n?V.addClass(s,"weui-btn_disabled"):V.removeClass(s,"weui-btn_disabled"),
...
var n=e.live_info[t],i=w(n.notice_id);
if(i&&i.length>0){
var o=i[0];
(n.status!==o.status||n.reservation!==o.reservation)&&(o.reservation=n.reservation,
o.status=n.status,j(n.notice_id,n.status,n.reservation,o.start_time));
}
}
},
error:function(){}
...
function x(){
T.bindVisibilityChangeEvt(function(e){
e&&A();
});
}
function I(){
_(),v(),b(),f(),x(),T.on(window,"scroll",y);
}
function S(){
var e=document.getElementById("js_content");
if(e){
L=e.getElementsByTagName("mpvideosnap")||[];
for(var t=0;t<L.length;t++){
var n=L[t],i=n.getAttribute("data-id")||n.getAttribute("data-noticeid")||"",o=n.getAttribute("data-type")||"video",a=void 0;
if("live"===o){
var r=n.getAttribute("data-noticeid")||"",s=w(r),d=s.length>0?s[0]:{};
a={
snapType:"live",
...
var s=p(i),c=s.length>0?s[0]:{},u=4===c.media_type||9===c.media_type?"video":"image";
a={
...
l.innerHTML=C.tmpl(O,a),l.firstElementChild&&n.appendChild(l.firstElementChild);
...
async:!0,
success:function(e){
e&&e.base_resp&&0===e.base_resp.ret&&(P=e.video_snap_info||[],H=e.live_info||[]),
S();
},
error:function(){
S();
...
var C=e("biz_common/tmpl.js"),T=e("biz_common/dom/event.js"),z=e("biz_wap/jsapi/core.js"),W=e("appmsg/appmsg_card.js"),O=e("appmsg/channel/video_snap_tpl.html.js"),U=e("biz_wap/utils/ajax.js"),q=e("biz_wap/utils/mmversion.js"),N=e("biz_wap/utils/device.js"),F=e("pages/utils.js"),B=e("common/utils.js"),M=e("common/comm_report.js"),D=e("appmsg/channel/time_format.js"),R=e("appmsg/channel/report_live.js"),V=e("biz_common/dom/class.js"),L=[],P=[],H=[],J=[],G=[],K=1,Q=0;
try{
Q=1*window.atob(window.biz);
}catch(X){}
E();
});var _extends=Object.assign||function(e){
