...
var m=p[a];
m.setPlayer(this),!!m.init&&m.init();
}
...
o.find(".js_video_pause_controll")),f=o.find(".js_full_screen_control"),m=o.find(".js_share_btn"),v=o.find(".js_sub_setting");
if(this.opt.canShareVideo&&(m[0]&&_.on(m[0],"click",function(){
...
if(e.target!==d[0]&&!d[0].contains(e.target)&&e.target!==m[0]&&!(t._useWcSlPlayer()&&(e.target===v[0]||v[0].contains(e.target))||t.isEnd()||t._g.touchForwarding)){
...
}),_.on(n[0],"click",function(e){
e.stopPropagation&&e.stopPropagation(),t.firstPlay();
},!0),_.tap(n[0],function(e){
e.stopPropagation&&e.stopPropagation(),t.firstPlay();
},!0),_.tap(r[0],function(){
t.playSwitch();
...
v.removeClass("hide"),i.css("display","flex"),n.length&&"flex"===n.css("display")&&n.css("display","none"),
t._trigger("resolutionChange",{
action:"show"
}));
});
...
v.removeClass("hide"),n.css("display","flex"),i.length&&"flex"===i.css("display")&&i.css("display","none"),
t._trigger("rateChange",{
action:"show"
}));else{
...
o.log.loadwait_start=+new Date,(!n.attr("src")||i)&&(n.attr("src",e+="&support_redirect=1"),
...
var i="",o="",n="";
try{
i=l.msg_link.html(!1),o=l.user_name||(window.cgiData?window.cgiData.username||window.cgiData.user_name:"")||"",
n=l.nickname||(window.cgiData?window.cgiData.nick_name:"")||"";
}catch(a){
...
try{
if(r=l.source||"",o=l.msg_link.html(!1),n=l.user_name||(window.cgiData?window.cgiData.username||window.cgiData.user_name:"")||"",
a=l.nickname||(window.cgiData?window.cgiData.nick_name:"")||"",this.opt.videoCrossOrigin){
...
console.log("??????????"),this.container.find(".js_video_play_controll").show();
},
