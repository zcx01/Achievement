...
var t=e("biz_common/tmpl.js"),i=e("biz_wap/utils/ajax.js"),n=e("biz_wap/jsapi/core.js"),o=e("appmsg/related_article_tpl.html.js"),a=e("appmsg/related_article_item.html.js"),r=e("biz_wap/utils/openUrl.js"),l=e("biz_common/dom/event.js"),s=e("common/utils.js"),d=e("biz_common/dom/class.js"),m=e("biz_common/utils/url/parse.js"),c=e("common/comm_report.js"),u=e("appmsg/related_article_feedback.js"),p=e("biz_wap/utils/mmversion.js"),_=e("biz_wap/utils/device.js"),w=e("appmsg/set_font_size.js").setFontSize,g=e("biz_wap/utils/jsmonitor_report.js"),h=e("pages/utils.js"),f=h.getId,j=h.getByClass,v=h.qs,b=h.formatReadNum,y=h.getScrollTop,z=h.getDefaultFontSize,x=e("pages/scrollY.js"),T=s.getInnerHeight();
...
P&&window.WX_BJ_REPORT.BadJs.report("relatedArticleFlag","value:"+window.relatedArticleFlag,{
...
null!==C&&(l.off(R.area,"transitionend",C),C=null);
};
C=function(e){
e.target===R.area&&"height"===e.propertyName&&(R.area.style.overflow="visible",M());
};
var L=function(e,t){
...
return 0===e?(R.area.style.overflow="hidden",R.area.style.margin="0",M()):(R.area.style.margin="12px 0",
a=e*n+o),R.area.style.height=a+"em",E&&e&&C&&C({
target:R.area,
propertyName:"height"
}),t?(I||(I=R.placeholder?v("div",R.placeholder).getBoundingClientRect().height:v(".js_related_item",R.list).getBoundingClientRect().height),
e*I+v(".js_related_title",R.main).getBoundingClientRect().height):void 0;
},H=function(e){
...
var a=e[o];
1*a.dataset.hasreport!==1&&a.clientHeight+a.offsetTop>=t+a.clientHeight/2&&a.clientHeight+a.offsetTop<=t+a.clientHeight/2+s.getInnerHeight()&&!function(e,t){
...
url:"/mp/relatedarticle?action=getlist&count="+n+"&begin="+e+"&article_url="+window.encodeURIComponent(location.href)+"&__biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&has_related_article_info="+window.hasRelatedArticleInfo+"&is_from_recommand="+(Q?1:0),
type:"GET",
dataType:"json",
success:function(i){
i&&i.base_resp&&1*i.base_resp.ret===0&&i.list&&i.list.length?!function(){
var o=i.list.map(function(e){
return Q&&(e.url=e.url.replace(/#wechat_redirect/,"&show_related_article=1$&")),
e.like_num_wording=e.old_like_num?b(e.old_like_num):"",e.read_num_wording=e.read_num?b(e.read_num):"",
e.pay_cnt_wording=e.pay_cnt?b(e.pay_cnt):"",e.ext_info=e.ext_info.html(!0),e;
});
...
Array.prototype.forEach.call(J(t.tmpl(a,{
list:o,
reason:k,
begin:e
})),function(e){
l.appendChild(e.cloneNode(!0));
}),R.list.appendChild(l),I=v("div",R.placeholder).getBoundingClientRect().height,
...
l.on(R.list,"click",".js_related_item",function(e){
...
isFromRecommend:Q,
render:function(e,i){
if(!B&&1*window.item_show_type===0&&""!==window.item_show_type){
if(E=i,!E){
var n=R.bottomOpr.getBoundingClientRect(),a=n.top,r=n.bottom;
if(a>T||0>r)return;
}
B=!0,R.container.innerHTML=t.tmpl(o,{
type:e
}),R.area=v(".js_related_area",R.container),E&&(R.area.style.transition="none"),
R.main=v(".js_related_main",R.area),R.list=v(".js_related_list",R.main),R.placeholder=v(".js_related_placeholder",R.main),
D(),X();
}
}
};
...
function t(e){
if(window.hasChannelTwoTab&&M.isNewNativePage()){
var n=void 0;
...
function u(e){
if("en"===window.LANG)return C.dealLikeReadShow_en(e);
var n="";
...
function b(e,n){
return O.getQuery("__biz",e)+"_"+O.getQuery("mid",e)+"_"+O.getQuery("idx",e)+"_"+n;
}
function k(e,n){
...
function y(e,n){
if(n.useSwitchVideo||M.isNativePage())I.invoke("handleMPPageAction",_extends({
action:"switchVideo",
scene:n.clickScene,
...
},document.location.protocol+"//mp.weixin.qq.com");else if(!window.__failConfigWxOpen&&M.isWcSlPage())n.leaveReport(),
M.loadNewPageKeepingHistoryStackIfSecOpen(e.url);else{
console.log("==================JSAPI.invoke openWebViewUseFastLoad",window.__failConfigWxOpen,M.isWcSlPage());
...
if(!e)return!1;
var o=!1,r=0,a=0,s=!1,c=!1,l=i===i.window?z:i.getBoundingClientRect().width,u=i===i.window?F:i.getBoundingClientRect().height;
